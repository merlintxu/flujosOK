...
--
-- Servidor: localhost
-- Tiempo de generación: 22-07-2025 a las 15:36:42
...
--
-- Volcado de datos para la tabla `api_configurations`
--

INSERT INTO `api_configurations` (`id`, `api_name`, `api_url`, `api_key_encrypted`, `api_token_encrypted`, `timeout_seconds`, `rate_limit_per_minute`, `active`, `last_health_check`, `health_status`, `created_at`, `updated_at`) VALUES
(1, 'ringover', 'https://public-api.ringover.com', 'fae17469b847770c06352a367a12e740bf174595', NULL, 30, 60, 1, NULL, 'healthy', '2025-07-17 21:27:44', '2025-07-17 21:27:44'),
(2, 'pipedrive', 'https://api.pipedrive.com/v1', NULL, 'cf544ac7d7bcd0cf1cf8f4d32b6b83444caae6f6', 30, 100, 1, NULL, 'healthy', '2025-07-17 21:27:44', '2025-07-17 21:27:44'),
(3, 'openai', 'https://api.openai.com/v1', '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', NULL, 60, 20, 1, NULL, 'healthy', '2025-07-17 21:27:44', '2025-07-17 21:27:44');
