...
--
-- Servidor: localhost
-- Tiempo de generación: 10-08-2025 a las 12:12:12
...
,`duration` int(11)
,`status` enum('pending','completed','answered','missed','busy','failed')
...
ALTER TABLE `calls`
  ...
  ADD UNIQUE KEY `calls_ringover_id_unique` (`ringover_id`),
