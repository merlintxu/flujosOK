...
class JwtController
{
    ...
    public function index(): void
    {
        ...
        $env = @parse_ini_file($this->basePath.'/.env', false, INI_SCANNER_RAW) ?: [];
        $vars = [
    ...
    public function importPem(): void
    {
        ...
        try {
            ...
            $pub  = (isset($_FILES['public_pem']) && $_FILES['public_pem']['error'] === UPLOAD_ERR_OK) ? $_FILES['public_pem']['tmp_name'] : null;
